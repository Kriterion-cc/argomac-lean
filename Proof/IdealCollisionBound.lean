...
import Proof.CircuitMaskDistribution
...
/-- The row-pair index has 4095 elements. -/
theorem pointRowPair_card : Fintype.card PointRowPair = 4095 := by
...
abbrev CircuitOnlineCoin := (Fin 90 → Point) ×
